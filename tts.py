...
class PitchManager:
    ...
    Style tiene coherencia cuando se selecciona la opcion linear para definir 
...
#Obtiene tiempos donde empiezan segmentos
def processSegments():
...
def main(argv):
    ...
    selects += 'Save as WAV file... ' + outputfile
